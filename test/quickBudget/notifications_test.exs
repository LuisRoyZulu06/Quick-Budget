defmodule QuickBudget.NotificationsTest do
  use QuickBudget.DataCase

  alias QuickBudget.Notifications

  describe "tbl_email" do
    alias QuickBudget.Notifications.Email

    import QuickBudget.NotificationsFixtures
  ...
  describe "tbl_sms" do
    alias QuickBudget.Notifications.Sms
