defmodule QuickBudgetWeb.UserController do
  ...
  plug(
    QuickBudgetWeb.Plugs.EnforcePasswordPolicy
    when action in [:new_password, :change_password]
  )

  plug(
    QuickBudgetWeb.Plugs.RequireAdminAccess
